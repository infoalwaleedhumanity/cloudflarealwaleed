...
export default function VisionPage() {
  return (
    <div>
      ...
      <div className="page-header py-10 md:py-20 bg-gradient-to-r from-[#1A3C6E] to-[#2456A4] text-white">
        <div className="max-w-[1600px] w-full mx-auto px-5 md:px-10 lg:px-16 2xl:px-20 text-center">
          <h1 className="text-3xl md:text-5xl font-bold mb-4 md:mb-6 font-cairo">رؤيتنا ورسالتنا</h1>
      ...
      <section className="py-10 md:py-20 bg-[#F8FAF7]">
        <div className="max-w-[1600px] w-full mx-auto px-5 md:px-10 lg:px-16 2xl:px-20">
          ...
          >
            {/* Left Hero */}
            <div className="w-full lg:w-[55%] h-[300px] md:h-[500px] relative bg-gradient-to-br from-[#2F4F2F] to-[#1a2c1a] rounded-[20px] md:rounded-[32px] p-6 md:p-12 overflow-hidden shadow-2xl flex items-center justify-center">
               ...
               <div className="relative z-10 text-white text-center">
                  <h3 className="text-2xl md:text-4xl font-bold font-cairo mb-2 md:mb-4">نحن نصنع الأثر</h3>
            ...
            <div className="w-full lg:w-[45%] flex flex-col gap-4 md:gap-8">
              ...
              >
                 <div className="w-12 h-12 md:w-16 md:h-16 bg-[#2F4F2F]/10 rounded-full flex items-center justify-center mb-4 md:mb-6">
                   <Target className="w-6 h-6 md:w-8 md:h-8 text-[#2F4F2F]" />
                 </div>
                 <h2 className="text-[#2F4F2F] font-bold text-xl md:text-2xl mb-2 md:mb-4 font-cairo">رؤيتنا</h2>
              ...
              <motion.div
                ...
                className="relative bg-white/70 backdrop-blur-lg border border-white/50 rounded-[20px] md:rounded-[32px] p-6 md:p-10 shadow-xl shadow-gray-200/50"
              >
                 <div className="w-12 h-12 md:w-16 md:h-16 bg-[#C9A84C]/10 rounded-full flex items-center justify-center mb-4 md:mb-6">
                   <Rocket className="w-6 h-6 md:w-8 md:h-8 text-[#C9A84C]" />
                 </div>
                 <h2 className="text-[#C9A84C] font-bold text-xl md:text-2xl mb-2 md:mb-4 font-cairo">رسالتنا</h2>
                 <p className="text-gray-600 leading-relaxed text-base md:text-lg font-cairo">
          ...
          <div className="text-center mb-8 md:mb-14">
            ...
            <h2 className="text-2xl md:text-4xl font-bold mt-3 font-cairo text-[#111827]">أهدافنا الاستراتيجية 2025-2030</h2>
            <div className="w-20 h-1 bg-[#C9A84C] mx-auto mt-4 rounded-full"/>
          </div>

          <div className="relative max-w-4xl mx-auto py-5 md:py-10">
            {/* Timeline Line */}
            <div className="absolute left-1/2 top-0 bottom-0 w-0.5 bg-gradient-to-b from-[#C9A84C] to-[#2F4F2F] opacity-30 transform -translate-x-1/2 hidden md:block"></div>
            ...
            {[
              ...
              >
                 ...
                 <div className="z-10 w-8 h-8 md:w-10 md:h-10 bg-white border-2 border-[#C9A84C] rounded-full flex items-center justify-center shadow-lg my-2 md:my-0">
                    <div className="w-2 h-2 md:w-3 md:h-3 bg-[#C9A84C] rounded-full"></div>
                 </div>
                 <motion.div 
                 ...
                 >
                    <div className="w-12 h-12 md:w-16 md:h-16 bg-[#2F4F2F]/5 rounded-xl md:rounded-2xl flex items-center justify-center mb-4 md:mb-6">
                        <g.icon className="w-6 h-6 md:w-8 md:h-8 text-[#2F4F2F]" />
                    </div>
                    <h3 className="font-bold text-lg md:text-xl mb-2 md:mb-3 text-[#111827] font-cairo">0{g.id} {g.title}</h3>
          ...
          <div className="mt-10 md:mt-20 rounded-[20px] md:rounded-3xl p-6 md:p-10 text-center bg-white border border-gray-100 shadow-xl shadow-gray-100">
            <h3 className="font-black text-xl md:text-2xl mb-4 md:mb-6 font-cairo text-[#033500]">مبادئنا الراسخة</h3>
            <div className="flex flex-wrap gap-2 md:gap-3 justify-center">
              {['الإنسانية أولاً', 'الشفافية التامة', 'الكفاءة العالية', 'الاستدامة', 'الشمولية', 'الابتكار', 'التعاون', 'الأثر الحقيقي'].map((v) => (
                <span key={v} className="px-4 md:px-5 py-1.5 md:py-2 rounded-full font-semibold text-xs md:text-sm font-cairo bg-gray-50 text-[#033500] border border-gray-100">
                  {v}
                </span>
              ))}
            </div>
