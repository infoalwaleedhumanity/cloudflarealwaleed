    ...
    <div>
      ...
      <div className="page-header text-center">
        <div className="relative z-10 max-w-[1600px] w-full mx-auto px-5 md:px-10 lg:px-16 2xl:px-20">
          <div className="flex items-center justify-center gap-2 text-sm mb-4">
            ...
            <span className="breadcrumb-item active" style={{fontFamily: 'var(--font-body)'}}>الشروط والأحكام</span>
          </div>
          <h1 className="text-white font-black mb-4" style={{fontSize:'clamp(2rem,5vw,3.5rem)',fontFamily: 'var(--font-heading)'}}>الشروط والأحكام</h1>
      ...
      <section className="py-24">
        <div className="max-w-[1600px] w-full mx-auto px-5 md:px-10 lg:px-16 2xl:px-20">
            ...
            {sections.map((section, i) => (
              <div key={i} className="rounded-2xl overflow-hidden" style={{border:'1px solid rgba(var(--primary-rgb),0.08)'}}>
                <div className="p-5 flex items-center gap-4" style={{background:'linear-gradient(135deg,rgba(var(--primary-rgb),0.04),rgba(var(--accent-rgb),0.06))'}}>
                  <div className="w-8 h-8 rounded-full flex items-center justify-center text-white text-sm font-bold flex-shrink-0" style={{background:'linear-gradient(135deg,var(--gold),var(--gold))'}}>
                    {i + 1}
                  </div>
          ...
          <div className="mt-12 p-8 rounded-3xl text-center" style={{background:'linear-gradient(135deg,var(--background),rgba(var(--primary-rgb), 0.05))'}}>
            <h3 className="font-black text-xl mb-3" style={{fontFamily: 'var(--font-heading)',color:'var(--primary)'}}>هل لديك استفسار قانوني؟</h3>
            <p className="text-[var(--primary)]/60 mb-6" style={{fontFamily: 'var(--font-body)'}}>فريقنا القانوني جاهز للإجابة على تساؤلاتك</p>
